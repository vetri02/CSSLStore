  ...
  return {
    ...
    setCSS: function(url) {
      ...
      try {
        ...
        //document.write('<link type="text/css" rel="stylesheet" href="'+window.location.href+url+'?v='+versionNumber+'" />');
...
//CSSLStore.setCSS(window.location.href + "/css/main.css?v="+Math.random().toString(36).substr(2));
CSSLStore.setCSS(window.location.href + "css/main.css");